...
class TaskListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.title = "Photo Scavenger Hunt"

        // Customize the navigation bar title appearance (color, font size, etc.)
        let appearance = UINavigationBarAppearance()
        appearance.configureWithOpaqueBackground()
        appearance.backgroundColor = UIColor.white // Set the background color of the navigation bar

        appearance.titleTextAttributes = [
            .foregroundColor: UIColor.systemBlue, // Set the text color to blue
            .font: UIFont.systemFont(ofSize: 24, weight: .bold) // Set the font and size
        ]
